...
MANAGED_SCRIPT_BINDINGS = (
	...
	(('Ui_inject/Inject_Custom/fam_script_callbacks', 'Ui_inject/Inject_custom/fam_script_callbacks', 'Ui_scripts/fam_script_callbacks'), os.path.join('Ui_inject', 'Inject_Custom', 'fam_script_callbacks.py')),
